...
func TestNewString(t *testing.T) {
	assert.Equal(t, &FieldString{t: value.TypeText, maxLength: new(1)}, NewString(value.TypeText, new(1)))
}
...
func TestFieldString_Clone(t *testing.T) {
	...
	assert.Equal(t, &FieldString{t: value.TypeText, maxLength: new(1)}, (&FieldString{t: value.TypeText, maxLength: new(1)}).Clone())
}
