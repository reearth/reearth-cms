...
func TestAccessibility_PostingEnabled(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "posting disabled", a: &Accessibility{posting: &PostingSettings{allowedOrigins: []string{}}}, want: false},
		{name: "posting enabled", a: &Accessibility{posting: &PostingSettings{allowedOrigins: []string{"https://example.com"}}}, want: true},
	}
