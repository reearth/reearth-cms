...
func (r *Item) FindByID(ctx context.Context, itemID id.ItemID, ref *version.Ref) (item.Versioned, error) {
	if r.err != nil {
		return nil, r.err
	}
...
func (r *Item) FindByIDs(ctx context.Context, list id.ItemIDList, ref *version.Ref) (item.VersionedList, error) {
	if r.err != nil {
		return nil, r.err
	}
