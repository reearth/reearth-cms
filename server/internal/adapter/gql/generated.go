...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "AssetFile.asset":
		if e.complexity.AssetFile.Asset == nil {
			break
		}

		return e.complexity.AssetFile.Asset(childComplexity), true
	...
	case "AssetFile.uploadedById":
		if e.complexity.AssetFile.UploadedByID == nil {
			break
		}

		return e.complexity.AssetFile.UploadedByID(childComplexity), true
...
schema {
  ...
  mutation: Mutation
	...
	{Name: "./schemas/asset.graphql", Input: `type AssetFile {
  assetId: ID!
  asset: Asset!
  name: String!
  size: FileSize!
...
func (ec *executionContext) _AssetFile_asset(ctx context.Context, field graphql.CollectedField, obj *gqlmodel.AssetFile) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _AssetFile_uploadedById(ctx context.Context, field graphql.CollectedField, obj *gqlmodel.AssetFile) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Query_assets(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Assets(rctx, args["teamId"].(gqlmodel.ID), args["keyword"].(*string), args["sort"].(*gqlmodel.AssetSortType), args["pagination"].(*gqlmodel.Pagination))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _AssetFile(ctx context.Context, sel ast.SelectionSet, obj *gqlmodel.AssetFile) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "asset":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._AssetFile_asset(ctx, field, obj)
			}
		...
		case "uploadedById":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._AssetFile_uploadedById(ctx, field, obj)
			}
