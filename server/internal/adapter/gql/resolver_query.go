...
func (r *queryResolver) CheckIfItemIsReferenced(ctx context.Context, itemId gqlmodel.ID, correspondingFieldId gqlmodel.ID) (*bool, error) {
	return loaders(ctx).Item.CheckIfItemIsReferenced(ctx, itemId, correspondingFieldId)
}
