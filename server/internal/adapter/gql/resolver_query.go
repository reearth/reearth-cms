...
func (r *queryResolver) CheckIfItemIsReferenced(ctx context.Context, itemId gqlmodel.ID) (*bool, error) {
	return loaders(ctx).Item.CheckIfItemIsReferenced(ctx, itemId)
}
