...
func (mr *MockAuthorizationMockRecorder) CheckPermission(ctx, resource, action interface{}, workspaceID ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, resource, action}, workspaceID...)
