...
func TestAsset_ConvertToSchemaFields(t *testing.T) {
	...
	tests := []struct {
		...
		seeds     []*asset.Asset
		seedFiles map[asset.ID]*asset.File
		want      *interfaces.AssetSchemaFieldsData
		wantErr   error
	}{
		{
			...
			want: &interfaces.AssetSchemaFieldsData{
				Fields: []interfaces.AssetSchemaField{
					{
						FieldName: "name",
						FieldType: "string",
					},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := assetUC.ConvertToSchemaFields(context.Background(), tt.args.assetID, tt.args.op)
...
func Test_extractSchemaFieldData(t *testing.T) {
	...
	tests := []struct {
		name           string
		args           args
		expectedFields []interfaces.AssetSchemaField
		expectedCount  int
		expectErr      error
	}{
		{
		...
		},
		{
			...
			expectedFields: []interfaces.AssetSchemaField{
				{FieldName: "name", FieldType: "string"},
				{FieldName: "elevation", FieldType: "integer"},
