...
type Project interface {
	...
	FindByWorkspaces(context.Context, accountdomain.WorkspaceIDList, *interfaces.ProjectFilter, *usecasex.Sort, *usecasex.Pagination) (project.List, *usecasex.PageInfo, error)
