...
// Test Suite: URL Field Testing
// ===========================

// Test creating and updating URL fields with basic functionality
export async function URLFieldCreatingAndUpdating(page: Page) {
  // Create new URL field with basic settings
  ...
  await expect(page.getByRole("cell", { name: "http://test2.com", exact: true })).toBeVisible();
    ...
    // Test editing URL fields with basic functionality
export async function URLFieldEditing(page: Page) {
  // Create new URL field with basic settings
  await page.locator("li").filter({ hasText: "URL" }).locator("div").first().click();
  await page.getByLabel("Display name").click();
  await page.getByLabel("Display name").fill("url1");
...
// Test Suite: URL Metadata Testing
// =============================

// Test creating and updating URL metadata fields with basic functionality
export async function URLMetadataCreatingAndUpdating(page: Page) {
  // Navigate to the URL metadata tab
...
// URL Metadata Editing Tests
// ==========================

// Test Suite: URL Metadata Editing Testing
// =====================================

// Test editing URL metadata fields with basic functionality
export async function URLMetadataEditing(page: Page) {
  // Navigate to the URL metadata tab
  await page.getByRole("tab", { name: "Meta Data" }).click();
  await page.locator("li").filter({ hasText: "Url" }).locator("div").first().click();
  await page.getByLabel("Display name").click();
