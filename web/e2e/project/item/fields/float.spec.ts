...
test("Float field creating and updating has succeeded", async ({ page, fieldEditorPage, contentPage, schemaPage }) => {
...
test("Float field editing has succeeded", async ({ page, fieldEditorPage, contentPage, schemaPage }) => {
