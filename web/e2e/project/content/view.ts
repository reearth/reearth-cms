...
// View CRUD operations test
export async function ViewCRUD(page: Page) {
  // Select text field and handle field form
  ...
  // Attempt to remove view but cancel
  await page.getByLabel("more").locator("svg").click();
...
// View reordering test
export async function ViewReordering(page: Page) {
  ...
  // Create third view and verify order
  await page.getByRole("button", { name: "Save as new view" }).click();
  await page.getByLabel("View Name").click();
