...
test("@focus Tiles CRUD has succeeded", async ({ settingsPage, page }) => {
...
test("@focus Terrain on/off and CRUD has succeeded", async ({ settingsPage, page }) => {
...
test("@focus Tiles reordering has succeeded", async ({ settingsPage, page }) => {
...
test("@focus Terrain reordering has succeeded", async ({ settingsPage, page }) => {
