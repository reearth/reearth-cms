...
test("@important Updating metadata added later from table has succeeded", async ({
  contentPage,
}) => {
...
test("@important Updating metadata added later from edit page has succeeded", async ({
  contentPage,
}) => {
  await contentPage.editButton.click();
