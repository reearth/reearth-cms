...
test("Url metadata creating and updating has succeeded", async ({
  ...
  await test.step("Create URL metadata field", async () => {
  ...
  await test.step("Verify field configuration", async () => {
  ...
  await test.step("Create new item with URL value", async () => {
  ...
  await test.step("Update URL from table inline edit", async () => {
  ...
  await test.step("Update URL from edit page", async () => {
...
test("Url metadata editing has succeeded", async ({ fieldEditorPage, contentPage, page }) => {
  await test.step("Create URL metadata field with default value", async () => {
    await fieldEditorPage.metaDataTab.click();
    await fieldEditorPage.fieldTypeListItem("URL").click();
    await fieldEditorPage.displayNameInput.fill("url1");
    await fieldEditorPage.fieldKeyInput.fill("url1");
  ...
  await test.step("Create item with default URL value", async () => {
    await fieldEditorPage.menuItemByName("Content").click();
  ...
  await test.step("Edit field to support multiple values and add validations", async () => {
    ...
    await fieldEditorPage.supportMultipleValuesCheckbox.click();
    await fieldEditorPage.validationTab.click();
    await fieldEditorPage.requiredFieldCheckbox.click();
    await fieldEditorPage.uniqueFieldCheckbox.click();
    await fieldEditorPage.defaultValueTab.click();
  ...
  await test.step("Verify updated field in content table", async () => {
    await fieldEditorPage.menuItemByName("Content").click();
  ...
  await test.step("Create new item with multiple default URLs", async () => {
    await contentPage.newItemButton.click();
  ...
  await test.step("Update URL value from table inline edit", async () => {
  ...
  await test.step("Add third URL value from edit page", async () => {
  ...
  await test.step("Verify all URL values in table", async () => {
    await contentPage.backButtonRole.click();
