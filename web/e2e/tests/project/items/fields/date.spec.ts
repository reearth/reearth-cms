...
test("Date field creating and updating has succeeded", async ({
  ...
  await test.step("Create Date field", async () => {
  ...
  await test.step("Clear date value from item", async () => {
...
test("Date field editing has succeeded", async ({
  ...
  await test.step("Create Date field with default value", async () => {
  ...
  await test.step("Create item with default date value", async () => {
    await contentPage.contentText.click();
  ...
  await test.step("Configure multiple default date values and reorder", async () => {
    await fieldEditorPage.defaultValueTab.click();
  ...
  await test.step("Create new item with multiple date values", async () => {
    await contentPage.newItemButton.click();
  ...
  await test.step("Verify multiple date values in table", async () => {
