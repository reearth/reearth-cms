...
test("Float field creating and updating has succeeded", async ({
  ...
  await test.step("Create Float field", async () => {
  ...
  await test.step("Create new item with float value", async () => {
  ...
  await test.step("Update float value", async () => {
...
test("Float field editing has succeeded", async ({
  ...
  await test.step("Create Float field with default value", async () => {
  ...
  await test.step("Create item with default float value", async () => {
    await schemaPage.contentText.click();
  ...
  await test.step("Configure validation rules with min/max values", async () => {
  ...
  await test.step("Configure multiple default values within validation range", async () => {
    await fieldEditorPage.defaultValueTab.click();
  ...
  await test.step("Create new item with multiple default float values", async () => {
    await contentPage.newItemButton.click();
