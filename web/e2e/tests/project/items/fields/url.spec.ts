...
test("URL field creating and updating has succeeded", async ({
  ...
  await test.step("Create URL field", async () => {
...
test("URL field editing has succeeded", async ({
  ...
  await test.step("Create URL field with default value", async () => {
  ...
  await test.step("Configure multiple default URL values", async () => {
    await fieldEditorPage.defaultValueTab.click();
  ...
  await test.step("Create new item with multiple default URL values", async () => {
    await contentPage.newItemButton.click();
