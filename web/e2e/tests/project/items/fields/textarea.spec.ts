...
test("Textarea field editing has succeeded", async ({
  ...
  await test.step("Create TextArea field with default value", async () => {
  ...
  await test.step("Create item with default textarea value", async () => {
  ...
  await test.step("Edit field to support multiple values and add validations", async () => {
    ...
    await fieldEditorPage.useAsTitleCheckbox.click();
    await fieldEditorPage.displayNameInput.click();
  ...
  await test.step("Configure multiple default values and reorder", async () => {
    await fieldEditorPage.defaultValueTab.click();
    await expect(fieldEditorPage.defaultValueTextInput).toHaveValue("text1 default value");
  ...
  await test.step("Create new item with multiple default textarea values", async () => {
    await contentPage.newItemButton.click();
  ...
  await test.step("Edit item to modify multiple textarea values", async () => {
