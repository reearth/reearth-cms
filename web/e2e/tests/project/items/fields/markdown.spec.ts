...
test("Markdown field editing has succeeded", async ({
  ...
  await test.step("Create Markdown field with default value", async () => {
  ...
  await test.step("Create item with default markdown value", async () => {
  ...
  await test.step("Create new item with multiple default markdown values", async () => {
    await contentPage.newItemButton.click();
  ...
  await test.step("Edit item to modify multiple markdown values", async () => {
