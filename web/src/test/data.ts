...
// Test ids and mock data shared by unit tests, components, and e2e tests.
// Keep this module free of DOM/testing-library imports — e2e (Playwright/Node)
// imports it, and @testing-library/react cannot load outside a browser-like env.
import type {
