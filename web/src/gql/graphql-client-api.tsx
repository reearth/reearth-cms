...
export type Query = {
  ...
  checkIfItemIsReferenced?: Maybe<Scalars['Boolean']>;
...
export type QueryCheckIfItemIsReferencedArgs = {
  itemId: Scalars['ID'];
};
