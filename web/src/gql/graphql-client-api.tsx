    ...
    nodes: Array<{
      ...
      schema: {
        ...
        fields: Array<{
          ...
          unique: boolean;
          typeProperty?:
          | { __typename?: "SchemaFieldAsset"; assetDefaultValue?: string | null }
          | { __typename?: "SchemaFieldBool" }
          | { __typename?: "SchemaFieldDate" }
          | {
            __typename?: "SchemaFieldInteger";
            min?: number | null;
            max?: number | null;
            integerDefaultValue?: number | null;
          }
          | {
            __typename?: "SchemaFieldMarkdown";
          ...
          | { __typename?: "SchemaFieldURL"; defaultValue?: string | null }
          | null;
        }>;
      };
    } | null>;
...
export const AddMemberToWorkspaceDocument = gql`
  ...
  ${WorkspaceFragmentFragmentDoc}
`;
export type AddMemberToWorkspaceMutationFn = Apollo.MutationFunction<
...
export function useAddMemberToWorkspaceMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<AddMemberToWorkspaceMutation, AddMemberToWorkspaceMutationVariables>(
    AddMemberToWorkspaceDocument,
    options,
  );
}
export type AddMemberToWorkspaceMutationHookResult = ReturnType<
  typeof useAddMemberToWorkspaceMutation
>;
export type AddMemberToWorkspaceMutationResult =
  Apollo.MutationResult<AddMemberToWorkspaceMutation>;
export type AddMemberToWorkspaceMutationOptions = Apollo.BaseMutationOptions<
  AddMemberToWorkspaceMutation,
  AddMemberToWorkspaceMutationVariables
>;
