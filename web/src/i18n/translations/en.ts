export default {
  ...
  "Permissions": "",
  "Personal Account": "",
  "Please add at least one origin to enable Posting": "Please add at least one origin to enable Posting",
  ...
  "PNG/JPEG/TIFF/GIF": "",
  "Posting": "",
  "Posting allows anonymous users to submit data to a model without authentication.": "Posting allows anonymous users to submit data to a model without authentication.",
