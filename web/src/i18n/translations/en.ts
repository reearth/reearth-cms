export default {
  ...
  "Permissions": "",
  "Personal Account": "",
  "Please add some items manually or import from JSON/GeoJSON/CSV": "Please add some items manually or import from JSON/GeoJSON/CSV",
  ...
  "The data file can contain a maximum of {{max}} records. Please split the file and re-upload it": "The data file can contain a maximum of {{max}} records. Please split the file and re-upload it",
  "The data file can contain a maximum of {{max}} records. Please split the file and re-upload it. And {{count}} fields do not match the schema._one": "The data file can contain a maximum of {{max}} records. Please split the file and re-upload it. And {{count}} fields do not match the schema.",
  "The data file can contain a maximum of {{max}} records. Please split the file and re-upload it. And {{count}} fields do not match the schema._other": "The data file can contain a maximum of {{max}} records. Please split the file and re-upload it. And {{count}} fields do not match the schema.",
  ...
  "unique": "",
  "Unknown Type": "",
  "Unmatched field hint_one": "Unmatched field hint",
  "Unmatched field hint_other": "Unmatched field hint",
  "Unpublish": "",
  "Unzip": "",
  "Update": "",
  ...
  "Updated By": "",
  "Upload": "",
  "Upload a data file in CSV, JSON, or GeoJSON formats. File must match the schema with field names and types. File can contain a maximum of {{max}} records.": "Upload a data file in CSV, JSON, or GeoJSON formats. File must match the schema with field names and types. File can contain a maximum of {{max}} records.",
  "Upload and Link": "",
  "Upload Asset": "",
  ...
  "You can also download file templates: CSV | JSON | GeoJSON": "You can also download file templates: CSV | JSON | GeoJSON",
  "You can also download file templates: JSON": "You can also download file templates: JSON",
