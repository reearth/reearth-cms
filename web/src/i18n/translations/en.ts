export default {
  ...
  "{{count}} configured_one": "{{count}} configured",
  "{{count}} configured_other": "{{count}} configured",
  "{{count}} errors_one": "{{count}} errors",
  "{{count}} errors_other": "{{count}} errors",
  ...
  "before or on": "",
  "Boolean": "",
  "Browser requests will be accepted only from the listed origins.": "Browser requests will be accepted only from the listed origins.",
  "Cancel": "",
  ...
  "Empty content cannot be exported": "Empty content cannot be exported",
  "Empty Schema design.": "",
  "Empty schemas cannot be exported": "Empty schemas cannot be exported",
  ...
  "Failed to update posting settings.": "",
  ...
  "One of the items has already been added to the request.": "",
  ...
  "Only Maintainer role or above can change the settings of the Post API": "Only Maintainer role or above can change the settings of the Post API",
  ...
  "Oops!": "",
  "Open API reference & playground": "Open API reference & playground",
  "Option": "",
  ...
  "Permissions": "",
  "Personal Account": "",
  "Please add at least one origin to enable Post API": "Please add at least one origin to enable Post API",
  ...
  "PNG/JPEG/TIFF/GIF": "",
  "Post API allows anonymous users to submit data to a model without authentication.": "Post API allows anonymous users to submit data to a model without authentication.",
  "POST API Enable": "POST API Enable",
  "Posting": "",
  ...
  "PUBLIC": "Public",
  "Public API": "",
  "Public API / New API Key": "Public API / New API Key",
  ...
  "Successfully updated posting settings!": "",
  ...
  "You can preview errors here or download the error log": "You can preview errors here or download the error log",
