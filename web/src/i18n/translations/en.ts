export default {
  ...
  "Once Public API is enabled, anyone with the endpoint can write data to the model. If a model is exposed via Public API, it cannot be restricted through API Key settings.": "",
