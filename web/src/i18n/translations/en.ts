export default {
  "... and {{count}} more errors_one": "... and {{count}} more errors",
  "... and {{count}} more errors_other": "... and {{count}} more errors",
  ...
  "defaultValue should be greater than minimum": "",
  "defaultValue should be in one of options": "",
  "defaultValue should be less than maximum": "",
  "defaultValue should be less than maxLength": "",
  "defaultValue type is invalid": "",
  "Delete": "",
  ...
  "each defaultValue item should be greater than minimum": "",
  "each defaultValue item should be less than maximum": "",
  "each defaultValue item should be less than maxLength": "",
  "Edit": "",
  "Email": "",
  ...
  "Import Schema": "",
  "Import successful!": "",
  "Importing into groups is not supported": "Importing into groups is not supported",
  "Importing into meta data is not supported": "Importing into meta data is not supported",
  "Importing...": "",
  ...
  "Integrations": "",
  "Invalid input: expected {{values}}": "Invalid input: expected {{values, list}}",
  "is": "",
  "is empty": "",
  "is not": "",
  "is not empty": "",
  ...
  "No Projects Yet": "",
  "No result": "",
  "No valid field type matched this configuration": "",
  "No Webhook yet": "",
  "Not import": "Not import",
  "Not supported": "",
  "Note: Only the first {{max}} errors are shown below.": "Note: Only the first {{max, number}} errors are shown below.",
  "Number": "",
  "of this month": "",
  "of this week": "",
  "of this year": "",
  ...
  "Permissions": "",
  "Personal Account": "",
  "Please add some field from right panel": "Please add some field from right panel",
  ...
  "The data file can contain a maximum of {{maxRecord}} records and below {{maxSizeInMB}} MB. Please split the file and re-upload it": "The data file can contain a maximum of {{maxRecord, number}} records and below {{maxSizeInMB, number}} MB. Please split the file and re-upload it",
  "The data file can contain a maximum of {{maxRecord}} records and below {{maxSizeInMB}} MB. Please split the file and re-upload it. And {{count}} fields do not match the schema._one": "The data file can contain a maximum of {{maxRecord, number}} records and below {{maxSizeInMB, number}} MB. Please split the file and re-upload it. And {{count}} fields do not match the schema.",
  "The data file can contain a maximum of {{maxRecord}} records and below {{maxSizeInMB}} MB. Please split the file and re-upload it. And {{count}} fields do not match the schema._other": "The data file can contain a maximum of {{maxRecord, number}} records and below {{maxSizeInMB, number}} MB. Please split the file and re-upload it. And {{count}} fields do not match the schema.",
  ...
  "Updated By": "",
  "Upload": "",
  "Upload a data file in CSV, JSON, or GeoJSON format. The file must match the required schema, including correct field names and data types. It may contain up to {{maxRecord}} records and must not exceed {{maxSizeInMB}} MB in size.": "Upload a data file in CSV, JSON, or GeoJSON format. The file must match the required schema, including correct field names and data types. It may contain up to {{maxRecord, number}} records and must not exceed {{maxSizeInMB, number}} MB in size.",
  "Upload and Link": "",
  "Upload Asset": "",
