export default {
  ...
  "The data file can contain a maximum of {{max}} records. Please split the file and re-upload it": "The data file can contain a maximum of {{max, number}} records. Please split the file and re-upload it",
  "The data file can contain a maximum of {{max}} records. Please split the file and re-upload it. And {{count}} fields do not match the schema._one": "The data file can contain a maximum of {{max, number}} records. Please split the file and re-upload it. And {{count, number}} fields do not match the schema.",
  "The data file can contain a maximum of {{max}} records. Please split the file and re-upload it. And {{count}} fields do not match the schema._other": "The data file can contain a maximum of {{max, number}} records. Please split the file and re-upload it. And {{count, number}} fields do not match the schema.",
